...
const operationalCards = [
  ...
  {
    icon: Orbit,
    label: "Tratamento autom?tico",
    description: "Padronize n?meros, mescle duplicados e acompanhe tudo em tempo real.",
  },
  {
    icon: Users,
    label: "Base tratada",
    description: "Use o painel como cockpit da opera??o de leads e amplificacao digital.",
  },
];
    ...
    <div className="space-y-6">
        ...
        <div className="grid gap-8 xl:grid-cols-[1.18fr_0.82fr]">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h2 className="max-w-4xl text-balance font-display text-4xl font-semibold leading-[1.02] text-white sm:text-5xl xl:text-6xl">
                Quem tem um <span className="text-[#a9f0ff]">Megafone</span> n?o precisa gritar.
              </h2>
              <p className="max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
                Centralize suas bases, deixe o tratamento de contatos no autom?tico e transforme sua opera??o digital
                em um fluxo mais previsivel, escal?vel e alinhado com a marca Megafone.
              </p>
            </div>
          ...
          <div className="brand-astronaut-card relative min-h-[360px] rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(57,213,255,0.28),transparent_45%),linear-gradient(180deg,rgba(9,24,46,0.9),rgba(5,14,29,0.96))] p-5 shadow-[0_28px_80px_rgba(3,9,21,0.46)]">
            ...
            <div className="absolute inset-x-0 bottom-0 rounded-b-[2rem] bg-gradient-to-t from-[#051020] via-[#051020]/85 to-transparent p-5 pt-20">
              <p className="brand-kicker">Opera??o em orbita</p>
              <h3 className="mt-2 font-display text-2xl font-semibold text-white">
                {activeLaunch ? activeLaunch.name : "Selecione um lan?amento para amplificar"}
              </h3>
              <p className="mt-3 text-sm leading-7 text-slate-300">
                {activeLaunch
                  ? "Esse lan?amento j? pode receber conex?es, regras e observabilidade com a nova identidade visual."
                  : "Crie ou escolha um lan?amento para ativar a cabine principal do sistema."}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
        <Card className="brand-card border-white/10 bg-[linear-gradient(180deg,rgba(8,23,46,0.92),rgba(4,12,24,0.84))]">
          <CardHeader>
            <CardTitle className="text-white">Panorama r?pido</CardTitle>
            <CardDescription className="text-slate-300">
              Um resumo do ambiente atual enquanto voc? constr?i a opera??o.
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-[1.4rem] border border-white/10 bg-white/5 p-4">
              <p className="text-sm text-slate-400">Lan?amentos mapeados</p>
        ...
        <SchemaSetupCard
          ...
          description="Continue usando esse card para validar rapidamente se o banco conectado j? recebeu tudo o que o app precisa."
        />
      </div>
    </div>
  );
