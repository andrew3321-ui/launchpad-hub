...
- Perfil de uso, permissões e vínculo administrativo

### 3.2. Dados operacionais de leads e contatos

O sistema pode receber e processar dados enviados por webhooks, automações ou integrações configuradas pelo próprio usuário, incluindo:

- Nome do contato
- Número de telefone
- Endereço de e-mail
- Tags e estados operacionais
- Origem do contato
- Dados de evento e data/hora de entrada
- Identificadores externos das plataformas conectadas
- Metadados necessários para deduplicação, mesclagem e roteamento
...
- IDs de listas, workspaces, bots, fluxos e planilhas
- Logs de processamento, resposta e auditoria
...
Nos termos da Lei Geral de Proteção de Dados Pessoais (LGPD), o tratamento poderá ocorrer com fundamento, conforme o caso, em:
...
- Consentimento, quando exigido pela legislação ou pela natureza específica da integração
...
O compartilhamento é limitado ao mínimo necessário para a execução das finalidades descritas nesta Política.

## 9. Armazenamento e retenção

Os dados serão armazenados pelo período necessário para:

- executar as funcionalidades da plataforma;
- manter histórico operacional, auditoria e segurança;
- cumprir obrigações legais ou regulatórias;
- viabilizar defesa em processos administrativos, arbitrais ou judiciais.

O tempo de retenção pode variar conforme o tipo de dado, a natureza da operação e a necessidade técnica ou jurídica de preservação.

## 10. Segurança da informação

Adotamos medidas técnicas e administrativas razoáveis e proporcionais para proteger os dados contra acessos não autorizados, destruição, perda, alteração, vazamento ou qualquer forma de tratamento inadequado ou ilícito.

Essas medidas podem incluir, conforme aplicável:

- controle de autenticação e perfis de acesso;
- registro de eventos e logs operacionais;
- segregação de ambientes;
- uso de credenciais e segredos de integração;
- monitoramento e revisão de permissões;
- práticas de desenvolvimento e manutenção voltadas à segurança.

Embora empreguemos esforços adequados, nenhum sistema é absolutamente invulnerável. Por isso, o usuário também é responsável por manter suas credenciais em sigilo e utilizar a plataforma de forma segura.

## 11. Direitos dos titulares

Nos termos da LGPD e da legislação aplicável, os titulares podem solicitar, quando cabível:
...
As solicitações poderão ser encaminhadas para o canal informado nesta Política, observadas as verificações necessárias de identidade e legitimidade.

## 12. Transferências internacionais

Dependendo dos provedores de infraestrutura, serviços em nuvem e integrações utilizadas, alguns dados podem ser processados fora do Brasil.

Nesses casos, buscaremos adotar medidas razoáveis para assegurar proteção adequada dos dados, em conformidade com a legislação aplicável.

## 13. Menores de idade

A plataforma não é direcionada intencionalmente a crianças e adolescentes sem a participação ou supervisão de responsável legal. Se houver indício de tratamento indevido de dados de menores em desconformidade com a legislação, a situação poderá ser apurada e tratada conforme o caso.

## 14. Cookies e tecnologias semelhantes

A plataforma pode utilizar cookies, armazenamento local e tecnologias correlatas para:

- autenticação;
- segurança;
- manutenção de sessão;
- preferências do usuário;
- funcionamento técnico da aplicação.

Eventuais ferramentas de análise e monitoramento, se utilizadas, deverão observar as regras aplicáveis.

## 15. Revogação de integrações e exclusão

O usuário pode:

- desconectar integrações externas conforme os recursos disponíveis na plataforma;
- remover ou substituir credenciais;
- revogar permissões diretamente nas plataformas conectadas, incluindo a conta Google;
- solicitar análise sobre exclusão de dados, observadas obrigações legais e limitações técnicas.

## 16. Alterações nesta Política

Esta Política poderá ser atualizada periodicamente para refletir mudanças operacionais, legais, regulatórias ou técnicas.

A versão mais atual será disponibilizada no canal oficial em que este documento estiver publicado, com indicação da data de atualização.
